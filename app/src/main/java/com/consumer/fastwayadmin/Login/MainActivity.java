package com.consumer.fastwayadmin.Login;
...
import com.consumer.fastwayadmin.Info.Info;
...
//        spinKitView = findViewById(R.id.spinKit);
        ...
        gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("765176451275-79b0cirodh8qa369aoens67j1lskbepq.apps.googleusercontent.com")
                .requestEmail()
                .requestProfile()
                .build();

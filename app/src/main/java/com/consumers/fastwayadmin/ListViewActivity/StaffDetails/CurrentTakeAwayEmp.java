...
public class CurrentTakeAwayEmp extends RecyclerView.Adapter<CurrentTakeAwayEmp.Holder> {
    ...
    public CurrentTakeAwayEmp(List<List<String>> finalDishNames, List<List<String>> finalDishQuantity, List<List<String>> finalHalfOr, List<String> finalUserNames,

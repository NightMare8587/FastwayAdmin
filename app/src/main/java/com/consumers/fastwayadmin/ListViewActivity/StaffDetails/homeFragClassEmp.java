...
public class homeFragClassEmp extends RecyclerView.Adapter<homeFragClassEmp.ViewHolder> {
    ...
    public homeFragClassEmp(List<String> tableNum, List<String> seats, List<String> resId, List<String> isCurrentOrder, List<String> amountPending){
        this.seats = seats;
        this.resId = resId;
